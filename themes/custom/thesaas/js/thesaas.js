      ...
      +function ($, window) {
        ...
        thesaas.topbar = function () {
          ...
          $(document).on('click', '.navbar-toggler', function () {
            ...
            $(this).closest('.navbar').prepend('<div class="backdrop backdrop-navbar"></div>');
          });
          ...
          //
          $(document).on('click', '.navbar-open .navbar-nav .nav-item > .nav-link', function () {
            /*var item = $(this),
        ...
        thesaas.typed = function () {
          ...
          $('[data-typing]').each(function () {
            var el = $(this);
            var strings = el.data('typing').split(',');
            var options = {
              strings: strings,
              typeSpeed: 50,
              backDelay: 800,
