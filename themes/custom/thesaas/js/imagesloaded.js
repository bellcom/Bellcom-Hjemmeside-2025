...
!(function (t, e) {
    ...
    function o(t, e) {
        var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : window.getComputedStyle(t, null),
            n = s(i[e]);
        return (
            W || "width" !== e ? W || "height" !== e || (n += s(i.paddingTop) + s(i.paddingBottom) + s(i.borderTopWidth) + s(i.borderBottomWidth)) : (n += s(i.paddingLeft) + s(i.paddingRight) + s(i.borderLeftWidth) + s(i.borderRightWidth)),
            n
        );
    }
    function r(t) {
    ...
    function p(t) {
        for (
            var e = t.itemSize, i = t.positions, n = t.gridSize, s = t.total, o = t.threshold, r = t.buffer, l = d(e.width, n, s, o), a = m(i, l, s), u = v(a, r), h = new A(Math.round(n * u), Math.round(a[u])), f = a[u] + e.height, c = 0;
            c < l;
            c++
        )
            i[u + c] = f;
    ...
    var N = window.getComputedStyle(V, null).width,
        W = "10px" === N;
    O.removeChild(V);
    var R = { reverse: !1, by: null, randomize: !1, key: "element" },
        H = {},
        q = "transitionend",
        P = 0,
        U = 0,
                ...
                M(
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var t = this;
                                return y(this.element.children)
                                    .filter(function (e) {
                                ...
                                return (
                                    (n =
                                        "function" == typeof this.options.columnWidth
                                            ...
                                            : this.useSizer
                                            ? t.getSize(this.options.sizer).width
                                            : this.options.columnWidth
                                            ? this.options.columnWidth
                                            : this.items.length > 0
                                            ? t.getSize(this.items[0].element, !0).width
                                            : e),
                                    0 === n && (n = e),
                                    n + i
                                );
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                return !this.isDestroyed && ((e.shuffle = this), !this.element.dispatchEvent(new CustomEvent(t, { bubbles: !0, cancelable: !1, detail: e })));
                            },
                        },
                        {
                            key: "_resetCols",
                        ...
                        },
                        {
                            ...
                            value: function (e) {
                                ...
                                e.forEach(function (e) {
                                    ...
                                    (u.transitionDelay = i._getStaggerAmount(n) + "ms"), i._queue.push({ item: e, styles: u, callback: s }), (n += 1);
                                });
                            },
                        },
                        {
    ...
    return (
        ...
        (Y.EventType = { LAYOUT: "shuffle:layout", REMOVED: "shuffle:removed" }),
        (Y.Classes = F),
        (Y.FilterMode = { ANY: "any", ALL: "all" }),
        (Y.options = {
            group: Y.ALL_ITEMS,
            speed: 250,
            easing: "ease",
